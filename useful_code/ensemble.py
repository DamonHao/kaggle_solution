...
class Ensemble(object):
    def __init__(self, n_folds, stacker, base_models, param_grid):
    ...
    def fit_predict(self, X, y, T):
        ...
        grid = model_selection.GridSearchCV(estimator=self.stacker, param_grid=self.param_grid, n_jobs=1, cv=5, verbose=20, scoring=RMSE)
        grid.fit(S_train, y)
